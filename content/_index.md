...
<div class="tiles-grid">
  ...
  <div class="tile tile-feature">
    ...
    <div class="tile-feature-text">
      <h3 class="tile-feature-title">Unlimited oncall schedules</h3>
      <p class="tile-feature-description">Set up flexible shifts and rotations from your <a href="https://docs.impulse.bot/configuration/oncall/#google-calendar" class="brand-color">Google Calendar</a></p>
    </div>
  </div>
  <div class="tile tile-feature">
    <div class="tile-feature-icon">
    ...
    <div class="tile-feature-text">
      <h3 class="tile-feature-title">Parent/child incident suppression</h3>
  ...
  <div class="tile tile-feature">
    ...
    <div class="tile-feature-text">
      <h3 class="tile-feature-title">Community support</h3>
      <p class="tile-feature-description">Ask questions and share ideas on <a href="https://github.com/eslupmi/impulse/discussions" class="brand-color">GitHub Discussions</a></p>
    </div>
  </div>
</div>
